					...
					<form method="post" action=""  enctype="multipart/form-data">
						<div class="row uniform">
							...
							<div class="4u 12u$(xsmall)">
								<input type="text" name="inv_where" value="" placeholder="code" />
							</div>
							<div class="4u 12u$(xsmall)">
								<input type="text" name="inv_howmuch" value="" placeholder="amount" />
							</div>
							<div class="4u$ 12u$(xsmall)">
								<input type="text" name="inv_when" value="" placeholder="date" />
							</div>
							<!-- text context -->
							<div class="12u$">
